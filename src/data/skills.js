export const skills = [
  ...
  },
  {
    ...
    description:
      "Cascading Style Sheets (CSS) is a language for styling web pages.  CSS rules target elements in the HTML document to specify the presentation, such as font, color, spacing, and size.",
    talents: ["Stylish"],
  },
  {
    id: 3,
    ...
    description:
      "Preprocessors like LESS and SASS help you write more structured and efficient CSS by adding features like variables, functions, and nesting.",
    stats: [
  ...
  },
  {
    ...
    dependsOn: [2],
    description:
      "You can bring design ideas to life by translating them into the requisite HTML document with CSS styles.",
    stats: [{ title: "Charisma", value: 10 }],
  },
  {
    id: 5,
    ...
    description:
      "jQuery provides techniques and methods for client-side manipulation of the web page elements.",
    talents: ["Sizzlin"],
    stats: [
      { title: "Charisma", value: 2 },
      { title: "Dexterity", value: 1 },
  ...
  },
  {
    ...
    description:
      "The process of affecting the ranking/visibility of a website or web page in a search engines results.",
    stats: [
      { title: "Intellect", value: 2 },
      { title: "Wisdom", value: 1 },
    ],
  },
  {
    id: 7,
    ...
    description:
      "Analytics provide performance data about a website as well as information that is usable to measure the success of SEO.",
    stats: [
      { title: "Intellect", value: 1 },
      { title: "Wisdom", value: 2 },
    ],
    talents: ["Crafty"],
  },
  {
    ...
    description:
      "JavaScript is the dominant language for client-side programming.  It executes in the user&rsquo;s browser to manipulate the HTML document after it has loaded.  This may be as simple as showing hidden elements, or more advanced like contacting the server to load more data.",
    stats: [{ title: "Dexterity", value: 3 }],
  },
  {
    id: 9,
    ...
    description:
      "Once you&rsquo;re comfortable with the JavaScript language, there&rsquo;s a multitude of libraries and frameworks to accomplish common tasks and enhance your development.",
    stats: [
  ...
  },
  {
    ...
    dependsOn: [9],
    stats: [{ title: "Dexterity", value: 10 }],
  },
  {
    id: 11,
    ...
    description:
      "Developing items (code) that executes on the server (server-side) instead of the user&raquo;s (client&raquo;s) machine.",
    stats: [{ title: "Strength", value: 3 }],
  },
  {
    id: 12,
